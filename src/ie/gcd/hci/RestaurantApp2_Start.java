...
public class RestaurantApp2_Start extends ListActivity {
	...
	private void fillData() {
		...
		// (only NAME)
		String[] from = new String[] { RestaurantApp2_DBAdapter.KEY_NAME };
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent i = new Intent(this, RestaurantApp2_DetailView.class);
