...
public class RestaurantApp2_DBAdapter {
	...
	private static final String DATABASE_NAME = "restaurantApp2_DB1";
	 ...
	 */
	public RestaurantApp2_DBAdapter(Context context) {
	 ...
	 */
	public RestaurantApp2_DBAdapter open() throws SQLException {
	...
	/**
	 * Create a new record using the name, address and phone provided. If the
	 * record is successfully created return the new rowId for that record,
	 ...
	 * @param phone
	 *            the phone of the record
	 * @param note
	 *            the note of the record
	 * @return rowId or -1 if failed
	 */
	public long createRecord(String name, String address, String phone,
			String note, float rating, String latitude, String longitude) {
	...
	public Cursor fetchAllRecords() {
		return mDb.query(DATABASE_TABLE, new String[] { KEY_ROWID, KEY_NAME,
				KEY_ADDRESS, KEY_PHONE, KEY_NOTE, KEY_RATING, KEY_LATITUDE,
	...
	public Cursor fetchRecord(long rowId) throws SQLException {
		Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] {
				KEY_ROWID, KEY_NAME, KEY_ADDRESS, KEY_PHONE, KEY_NOTE,
				KEY_RATING, KEY_LATITUDE, KEY_LONGITUDE }, KEY_ROWID + "="
	 ...
	 * specified using the rowId, and it is altered to use the name, address and
	 * phone values passed in
	 * 
	 * @param rowId
	 *            id of record to update
	 * @param name
	 *            value to set record name to
	 * @param address
	 *            value to set record address to
	 * @param phone
	 *            value to set record phone to
	 * @param note
	 *            value to set record note to
	 * @return true if the record was successfully updated, false otherwise
	 */
	public boolean updateRecord(long rowId, String name, String address,
			String phone, String note, float rating, String latitude,
			String longitude) {
